...
L'application et le package `archeoViz` sont développés et maintenus par Sébastien Plutniak. Arthur Coulon, Solène Denis, Olivier Marlet, et Thomas Perrin ont testé et soutenu ce projet durant ses premières étapes. Renata Araujo, Sara Giardino, Julian Laabs et Nicolas Delsol ont traduit l'application respectivement en portugais, italien, allemand, et espagnol.
