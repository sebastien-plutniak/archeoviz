...
* The 3D visualisation, the map and the section visualisation can all be exported in .svg format (by cliking on the “camera” icon in the menu bar above the plot).
* The 3D visualisation can be exported in interactive html format by clicking on the "Download" button.
