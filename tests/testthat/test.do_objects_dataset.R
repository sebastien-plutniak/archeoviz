test_that(".do_objects_dataset: simulated data", {
  ...
  expect_equal(c(sapply(res$data[1, ], typeof), use.names=F), c("integer", "integer", "integer", "integer", "double", "integer", "double", "double", "logical", "integer", "character", "character", "integer", "character","integer", "integer", "double", "character", "integer"))
})
