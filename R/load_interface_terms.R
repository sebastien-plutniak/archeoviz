...
.load_interface_terms <- function(lang){
  ...
  input.objects.fr <- 
    ...
    <ul>
      ...
      <li> <b>zmin</b> : <i>valeur numérique</i>, coordonnée de l'objet en axe Z (valeur positive de profondeur en cm)</li>
  ...
  input.objects.pt <- 
    ...
    <ul>
      ...
      <li> <b>zmin</b> : <i>valor numérico</i>, coordenada do objeto no eixo Z (valor de profundidade positiva em cm)</li>
  ...
  input.objects.it <- 
    ...
    <ul>
      ...
      <li> <b>zmin</b> : <i>valore numerico</i>, coordinata dell’oggetto sull’asse Z (valore positivo di profondità in cm)</li>
...
<li>ne sont pas affichés, afin d’éviter des affichages erronés, si le nombbre de labels ne correspond pas exactement au nombre total de carrés de 100 cm pouvant être définis dans l’intervalle des coordonnées minimales et maximales contenues dans les variables xmin et ymin ;</li>
