...
<ul>
<li>Plutniak, Sébastien. 2022. “archeoViz. Visualisation, Exploration, and Web Communication of Archaeological Excavation Data”. v0.1, DOI: <a href=https://doi.org/10.5281/zenodo.7460193>10.5281/zenodo.7460193</a>.</li>
</ul>
"
...
<p>Dans l’onglet “Plan”, cocher la case “Calculer la densité” et cliquer sur “Valider” génère un plan comportant des lignes de contour représentant la densité des points. La densité peut être calculée pour l’ensemble des points ou par couche. L’estimation bidimensionnelle de densité par noyau est calculée avec la fonction <code>kde2d</code> du package <a href=https://CRAN.R-project.org/package=MASS><code>MASS</code></a> (à travers le package <a href=https://CRAN.R-project.org/package=ggplot2><code>ggplot2</code></a>).</p>
</div>
</div>
</div>
...
<li>Plutniak, Sébastien. 2022. “archeoViz. Visualisation, Exploration, and Web Communication of Archaeological Excavation Data”. v0.1, DOI: <a href=https://doi.org/10.5281/zenodo.7460193>10.5281/zenodo.7460193</a>.</li>
  ...
  fr <- list(
    ...
    coords.type.error = "Le format de xmin, ymin, et/ou zmin n'est pas un nombre."
  ...
  en <- list(
    ...
    coords.type.error = "The format of some of xmin, ymin, and/or zmin is not number."
  )
  # switch
